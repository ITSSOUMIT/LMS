...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <?php
      $ongoingexamcheck = "SELECT * FROM exam where status=1";
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Scheduled Exams :</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        ...
                        <td>
                          <button type="button" class="btn btn-block btn-warning btn-xs" onclick="window.location.href='editExam?examid=<?php echo $ongoingexam['examid']; ?>'">Edit Exam Details</button>
                          <button type="button" class="btn btn-block btn-success btn-xs" onclick="window.location.href='changeExamState?examid=<?php echo $ongoingexam['examid']; ?>&from=1&to=2'">Start Exam</button>
                          <button type="button" class="btn btn-block btn-danger btn-xs" onclick="window.location.href='changeExamState?examid=<?php echo $ongoingexam['examid']; ?>&from=1&to=4'">Delete Exam</button>
                        </td>
                      </tr>
                    <?php
                      $c++;}
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">No Scheduled Exams found</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
