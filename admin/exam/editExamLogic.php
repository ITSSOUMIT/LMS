<?php
    ...
    if(is_uploaded_file($_FILES['questionpaper']['tmp_name'])){
        ...
        $updateexam = "UPDATE exam SET batchcode='$batchcode', examname='$examname', fullmarks='$fullmarks', examduration='$examduration', submissionduration='$submissionduration' WHERE examid='$examid'";
        $updateexamexec = mysqli_query($conn, $updateexam);
        echo "<script>
        alert('Exam Details Updated Successfully');
        window.location.href= '../dashboard';
