  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Schedule New Exam :</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="newExamLogic" method="POST" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Exam Code</label>
                    <input type="text" class="form-control" placeholder="Enter exam name" name="examid" value="<?php echo md5(date('dmYHisu')); ?>" readonly>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Exam Name</label>
                    <input type="text" class="form-control" placeholder="Enter exam name" name="examname" required>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="row">
                    <div class="col-4">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Enter full marks for the exam" name="fullmarks" required>
                      </div>
                    </div>
                    <div class="col-4">
                      <div class="form-group">
                        <label for="exampleInputEmail1">Exam Duration</label>
                        <input type="text" class="form-control" placeholder="Enter exam duration (in minutes)" name="examduration" required>
                      </div>
                    </div>
                    <div class="col-4">
                      <div class="form-group">
                        <label for="exampleInputEmail1">Submission Duration</label>
                        <input type="text" class="form-control" placeholder="Enter submission duration (in minutes)" name="submissionduration" required>
                      </div>
                    </div>  
                  </div>
                </div>
                ...
                <div class="card-footer">
                  <button type="submit" class="btn btn-primary">Schedule New Exam</button>
                </div>
              </form>
            </div>
            <!-- /.card -->
