...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <?php
      $ongoingexamcheck = "SELECT * FROM exam where status=3";
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Unevaluated Exams :</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        ...
                        <td>
                          <button type="button" class="btn btn-block btn-primary btn-xs" onclick="window.location.href='viewDetails?examid=<?php echo $ongoingexam['examid']; ?>'">View Exam Details</button>
                          <button type="button" class="btn btn-block btn-success btn-xs" onclick="window.location.href='changeExamState?examid=<?php echo $ongoingexam['examid']; ?>&from=3&to=0'">Mark as Checked & Publish Results</button>
                        </td>
                      </tr>
                    <?php
                      $c++;}
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">No Unevaluated Exams found</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
...
<?php
    if(isset($_GET['error'])){
      if(strcmp($_GET['error'], "unevaluatedAnswerSheets")==0){
?>
    <script type="text/javascript">
        $(window).on('load', function() {
            toastr.error('Unevaluated Answer Sheets Found. Cannot publish results')
        });
    </script>
<?php
    }}
