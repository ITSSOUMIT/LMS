    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="../exam/newExam" class="nav-link">
          ...
          <li class="nav-item">
            <a href="../exam/ongoingExam" class="nav-link">
          ...
          <li class="nav-item">
            <a href="../exam/scheduledExam" class="nav-link">
              <i class="nav-icon fas fa-book"></i>
              <p>
                Scheduled Exams
          ...
          <li class="nav-item">
            <a href="../exam/unevaluatedExam" class="nav-link">
              <i class="nav-icon fas fa-book"></i>
              <p>
                Unevaluated Exams
          ...
          <li class="nav-item">
            <a href="../exam/oldExam" class="nav-link">
              <i class="nav-icon fas fa-book"></i>
              <p>
                Old Exams
          ...
          <li class="nav-item">
            <a href="newBatch" class="nav-link">
              <i class="nav-icon fas fa-plus"></i>
              <p>
                New Batch
              </p>
          ...
          <li class="nav-item">
            <a href="viewBatch" class="nav-link">
          ...
          <li class="nav-item">
            <a href="viewStudent?batch=ALL" class="nav-link">
          ...
          <li class="nav-item">
            <a href="passwordResetReq" class="nav-link">
