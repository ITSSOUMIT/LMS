...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
      <li class="nav-item">
        <button type="button" class="btn btn-block btn-primary btn-sm nav-link" data-toggle="modal" data-target="#modal-default">Close</button>
      </li>
    </ul>
  </nav>
                ...
                <form>
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input id="nums" type="text" class="form-control" readonly required name="resultDivision" value="<?php if(isset($submission['resultDivision'])){ echo $submission['resultDivision']; } ?>">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1">Sum of Marks</label>
                            <input type="text" class="form-control" id="result" name="result" readonly value="<?php if(isset($submission['result'])){ echo $submission['result']; } ?>">
                        </div>
                        <div class="form-group">
                        <label>Comments :</label>
                            <textarea class="form-control" rows="6" name="resulttext" readonly required><?php if(isset($submission['resulttext'])){ echo $submission['resulttext']; } ?></textarea>
                        </div>
                    </div>
                    <!-- /.card-body -->
                </form>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer justify-content-between">
            ...
            <button type="button" class="btn btn-primary" onclick="window.location.href='attemptedExam'">Go Back</button>
        </div>
      </div>
      <!-- /.modal-content -->
    </div>
