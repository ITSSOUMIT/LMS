<?php
    ...
    $updatequery = "UPDATE submissions SET status=4 WHERE submissionid='$submissionid' AND examid='$examid'";
...
<head>
  ...
  <title>Upload Answer Script</title>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card card-primary">
                    <!-- form start -->
                    <form action="completeExam?examid=<?php echo $examid; ?>&submissionid=<?php echo $submissionid; ?>" method="POST"  enctype="multipart/form-data" required>
                        <div class="card-body">
                            <div class="form-group">
                                <label for="exampleInputFile">Answer Script</label>
                                <div class="input-group">
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" id="exampleInputFile" name="answerscript" accept="application/pdf">
...
<script>
    var sec         = <?php echo $submission['submissiontimeleft']; ?>,
    ...
    function secpass() {
        ...
        if (sec > 0) {
            ...
            window.location.href='completeExam?examid=<?php echo $examid; ?>&submissionid=<?php echo $submissionid; ?>'
...
<script>
  ...
  setInterval(function(){
    $.ajax({
        url : 'auxActions/uploadTimeLogger?examid=<?php echo $examid; ?>&submissionid=<?php echo $submissionid; ?>',
        type : 'POST',
