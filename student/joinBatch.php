<?php
    ...
    if(isset($_POST['intent'])){
        if(strcmp($_POST['intent'], "submit")==0){
            ...
            $checkquery = "SELECT * FROM batch WHERE batchcode='$batchcode' AND status=1";
            ...
            if(mysqli_num_rows($checkqueryresult) == 0){
                ...
                $updatebatch = "UPDATE userbase SET batch='$batchcode' WHERE userid='$userid'";
                $updatebatchquery = mysqli_query($conn, $updatebatch);

                //increase student count in the batch
                $increasequery = "UPDATE batch SET students = students + 1 WHERE batchcode='$batchcode'";
...
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
    ...
    <div class="card-body">
      <p class="login-box-msg">Join New Batch</p>
      ...
      <form action="" method="post">
        ...
        <div class="row mt-2 mb-3">
          <div class="col-12">
            <button type="submit" class="btn btn-primary btn-block">Join New Batch</button>
          </div>
          <!-- /.col -->
        </div>
        <div class="row mt-2 mb-3">
